  ...
  return(
    <div className="navbar">
        ...
        <div className="navbar__s2">
            <i className="fa-sharp fa-solid fa-magnifying-glass" style={{color: "#121212"}}></i>
        ...
        <div className="navbar__s3">
            ...
            <i className="fa-solid fa-bell" style={{color: "#080808"}}></i>
            <i className="fa-solid fa-user" style={{color: "#0d0d0d"}}></i>
